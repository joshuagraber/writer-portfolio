      ...
      >
        <nav className={navOpen ? 'show' : ''}>
          <ul onClick={handleNavClick}>
            <li>
              <NavLink to="/about" key="nav-1" className="navLink" activeClassName="navActive">
                About
              </NavLink>
            </li>
            <li>
              <NavLink to="/work" key="nav-2" className="navLink" activeClassName="navActive">
                Work
              </NavLink>
            </li>
            <li>
              <NavLink to="/io" key="nav-3" className="navLink" activeClassName="navActive">
                Blog
              </NavLink>
            </li>
          </ul>
